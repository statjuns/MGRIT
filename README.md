...
# For custom dataset
path/to/dataset/
├── text/# annotation txt files
    ├── train_text/      # train cpation, lang code
    ├── valid_text/      # valid cpation, lang code
    └── test_text/       # text cpation, lang code
├── train/    # train images
├── val/      # val images
└── test/     # test images

image path
text file naee = {image_file_name}.txt
...
export DATA_ROOT=path/to/coco_dataset
# with pretrained object detector on 4 datasets
python train_caption.py exp.name=caption_4ds_encn model.detector.checkpoint=4ds_detector_path \
...
# with pretrained object detector on 4 datasets
python train_caption.py exp.name=caption_4ds_encn model.detector.checkpoint=4ds_detector_path optimizer.freezing_xe_epochs=10 optimizer.freezing_sc_epochs=10 optimizer.finetune_xe_epochs=0 optimizer.finetune_sc_epochs=0 optimizer.freeze_backbone=True optimizer.freeze_detector=True
